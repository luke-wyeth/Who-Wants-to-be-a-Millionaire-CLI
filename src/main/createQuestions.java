...
public class createQuestions 
{
    ...
    public ArrayList create()
    {
        ...
        Question q1 = new Question(0,"Which is the closest start to the Earth?",new String[]{"The Sun","Mars","Alpha Centauri A","Alpha Centauri B"},1);
        Question q2 = new Question(0,"What animal was Flipper from the popular 0964 children’s show ‘Flipper’?",new String[]{"Whale","Seal","Dog","Dolphin"},4);
        ...
        Question q10 = new Question(1,"What was the most popular baby boy name in the year 0999?",new String[]{"Jacob","Luke","Nicholas","Matthew"},1);
